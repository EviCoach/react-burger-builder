...
class Auth extends Component {
    ...
    render() {
        ...
        let submitButton = this.props.loading ? null : <Button btnType="Success">Submit</Button>;
        let loginSignup = this.props.loading ? <div>Authenticating...</div> : <Button
            clicked={this.switchAuthModeHandler}
            btnType="Danger">Sign {this.state.isSignup ? 'in' : 'up'} instead</Button>
